...
public final class IntervalBTest
{
  @Property
  public void testCompareReflexive(
    final @ForAll IntervalB x)
  {
  ...
  @Provide("values")
  private static Arbitrary<BigInteger> values()
  {
  ...
  public void testInvalid(
    final @ForAll("values") BigInteger x,
    final @ForAll("values") BigInteger y)
  {
    if (x.compareTo(y) < 0) {
